                        ...
                        <div class="row p-3 mt-5">
                            ...
                            <form action="user" method="POST" class="col">
                                ...
                                <!-- <div class="col">
                                    ...
                                    <div class="d-flex flex-column">
                                        <input type="hidden" value="register" name="action">
                                        <input type="text" class="form-control  p-2 mt-2 shadow-sm border border-1" placeholder="Número" name="txtName">
                                        <input type="text" class="form-control p-2  mt-2 shadow-sm border border-1" placeholder="Complemento" name="txtSurname">
                                        <input type="email" class="form-control p-2  mt-2 shadow-sm border border-1" placeholder="Bairro" name="txtEmail">
                                        <input type="tel" class="form-control p-2  mt-2 shadow-sm border border-1" placeholder="Cidade" name="txtPhone">
                                        <input type="password" class="form-control p-2  mt-2 shadow-sm border border-1" placeholder="Estado" name="txtPassword">
                                        <input type="password" class="form-control p-2  mt-2 shadow-sm border border-1" placeholder="CEP" name="rp_password">
                                        <button type="submit" class="btn btn-primary px-4 mt-4">Registrar</button>
                                    </div>
                                </div> -->
                            </form>
